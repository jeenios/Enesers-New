...
class StockAdjustmentResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Stock Adjustment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('stockAdjustmentMultiple')
                                            ->relationship('stockAdjustmentMultiple')
                                            ->schema([
                                                Select::make('item_id')
                                                    ->label('Item')
                                                ...
                                                Select::make('unit_id')
                                                    ...
                                                    ->placeholder('')
                                                    ->required(),
                                                TextInput::make('buy_price_type')
                                                    ->required()
                                                    ->default(0)
                                                    ->required()
                                                    ->label('Buy Price Type'),
