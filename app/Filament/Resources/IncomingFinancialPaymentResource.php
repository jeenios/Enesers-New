...
use App\Filament\Resources\IncomingFinancialPaymentResource\Pages;
use App\Filament\Resources\IncomingFinancialPaymentResource\RelationManagers;
use App\Models\IncomingFinancialPayment;
use Filament\Forms;
...
class IncomingFinancialPaymentResource extends Resource
{
    protected static ?string $model = IncomingFinancialPayment::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Incoming Financial Payment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('incomingFinancialPaymentMultiple')
                                            ->relationship('incomingFinancialPaymentMultiple')
                                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListIncomingFinancialPayments::route('/'),
            'create' => Pages\CreateIncomingFinancialPayment::route('/create'),
            'edit' => Pages\EditIncomingFinancialPayment::route('/{record}/edit'),
        ];
    }
