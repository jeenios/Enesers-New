...
class StockUsageResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Stock Usage Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('stockUsageMultiple')
                                            ->relationship('stockUsageMultiple')
                                            ->schema([
                                                Select::make('item_id')
                                                    ->label('Item')
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateStockUsage::route('/create'),
            'edit' => Pages\EditStockUsage::route('/{record}/edit'),
        ];
    }
