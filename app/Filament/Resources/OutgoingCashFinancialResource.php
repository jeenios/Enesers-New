...
use App\Filament\Resources\OutgoingCashFinancialResource\Pages;
use App\Filament\Resources\OutgoingCashFinancialResource\RelationManagers;
use App\Models\OutgoingCashFinancial;
use Filament\Forms;
...
class OutgoingCashFinancialResource extends Resource
{
    protected static ?string $model = OutgoingCashFinancial::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Outgoing Cash Payment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('outgoingCashPaymentMultiple')
                                            ->relationship('outgoingCashPaymentMultiple')
                                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListOutgoingCashFinancials::route('/'),
            'create' => Pages\CreateOutgoingCashFinancial::route('/create'),
            'edit' => Pages\EditOutgoingCashFinancial::route('/{record}/edit'),
        ];
    }
