...
class PurchaseRequisitionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Purchase Requisition Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('purchaseRequisitionMultiple')
                                            ->relationship('purchaseRequisitionMultiple')
                                            ->schema([
                                                Select::make('item_id')
                                                    ->label('Item')
                                    ...
                                    ->schema([
                                        Grid::make(2)
                                            ->schema([
                                                ...
                                                // Shipment Address
                                                Fieldset::make('Shipment Address')
                                                    ->schema([
