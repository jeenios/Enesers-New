...
class PurchaseInvoiceWriteOffResource extends Resource
{
    protected static ?string $model = PurchaseInvoiceWriteOff::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Purchase Invoice Write Off Information')
                    ->tabs([
    ...
    {
        return [
            'index' => Pages\ListPurchaseInvoiceWriteOffs::route('/'),
            'create' => Pages\CreatePurchaseInvoiceWriteOff::route('/create'),
            'edit' => Pages\EditPurchaseInvoiceWriteOff::route('/{record}/edit'),
        ];
    }
