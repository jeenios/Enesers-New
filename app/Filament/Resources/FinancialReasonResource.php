...
use App\Filament\Resources\FinancialReasonResource\Pages;
use App\Filament\Resources\FinancialReasonResource\RelationManagers;
...
class FinancialReasonResource extends Resource
{
    protected static ?string $model = FinancialReason::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Finacial Reason Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
    ...
    {
        return [
            'index' => Pages\ListFinancialReasons::route('/'),
            'create' => Pages\CreateFinancialReason::route('/create'),
            'edit' => Pages\EditFinancialReason::route('/{record}/edit'),
        ];
    }
