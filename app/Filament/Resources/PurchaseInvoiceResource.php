...
class PurchaseInvoiceResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Purchase Invoice Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Toggle::make('is_part')
                                            ->label('Is Part of Order with Down Payment?')
                                            ->inlineLabel()
                                            ->extraAttributes(['class' => 'max-w-sm']),
                                        ...
                                        Repeater::make('purchaseInvoiceMultiple')
                                            ->relationship('purchaseInvoiceMultiple')
                                            ->columns(4)
                                            ->collapsible()
