...
use App\Filament\Resources\FinancialAccountResource\RelationManagers;
...
class FinancialAccountResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Financial Account Information')
                    ->tabs([
                        ...
                        Tabs\Tab::make('Accounting')
                            ->schema([
                                TextInput::make('incoming_payment')
                                    ->label('Incoming Payment')
                                    ->inlineLabel()
                                    ->extraAttributes(['class' => 'max-w-sm']),

                                TextInput::make('outgoing_payment')
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('currency.code')
                    ->searchable(),
                Tables\Columns\TextColumn::make('allow_draft')
                    ->badge()
