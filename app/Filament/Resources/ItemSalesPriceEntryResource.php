...
use App\Filament\Resources\ItemSalesPriceEntryResource\Pages;
use App\Filament\Resources\ItemSalesPriceEntryResource\RelationManagers;
use App\Models\Item;
use App\Models\ItemSalesPriceEntry;
use App\Models\Unit;
use Filament\Forms;
...
class ItemSalesPriceEntryResource extends Resource
{
    protected static ?string $model = ItemSalesPriceEntry::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Item Sales Price Entry Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
                            ...
                            TextInput::make('date_entry_type')
                                ->label('Date Entry Type')
                                ->required()
                                ->inlineLabel()
                                ->extraAttributes(['class' => 'max-w-sm']),
                            ...
                            Repeater::make('itemSalesPriceEntries')
                                ->relationship('itemSalesPriceEntries')
                                ->schema([
                                    Select::make('item_id')
                                        ->label('Item')
    ...
    {
        return [
            'index' => Pages\ListItemSalesPriceEntries::route('/'),
            'create' => Pages\CreateItemSalesPriceEntry::route('/create'),
            'edit' => Pages\EditItemSalesPriceEntry::route('/{record}/edit'),
        ];
    }
