...
use App\Filament\Resources\CashAdvanceReasonResource\Pages;
use App\Filament\Resources\CashAdvanceReasonResource\RelationManagers;
use App\Models\CashAdvanceReason;
use Filament\Forms;
...
class CashAdvanceReasonResource extends Resource
{
    protected static ?string $model = CashAdvanceReason::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Cash Advance Reason Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
    ...
    {
        return [
            'index' => Pages\ListCashAdvanceReasons::route('/'),
            'create' => Pages\CreateCashAdvanceReason::route('/create'),
            'edit' => Pages\EditCashAdvanceReason::route('/{record}/edit'),
        ];
    }
