...
use App\Filament\Resources\OutgoingFinancialPaymentResource\Pages;
use App\Filament\Resources\OutgoingFinancialPaymentResource\RelationManagers;
use App\Models\OutgoingFinancialPayment;
use Filament\Forms;
...
class OutgoingFinancialPaymentResource extends Resource
{
    protected static ?string $model = OutgoingFinancialPayment::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Outgoing Financial Payment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('outgoingFinancialPaymentMultiple')
                                            ->relationship('outgoingFinancialPaymentMultiple')
                                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListOutgoingFinancialPayments::route('/'),
            'create' => Pages\CreateOutgoingFinancialPayment::route('/create'),
            'edit' => Pages\EditOutgoingFinancialPayment::route('/{record}/edit'),
        ];
    }
