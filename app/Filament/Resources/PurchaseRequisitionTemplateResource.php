...
use App\Filament\Resources\PurchaseRequisitionTemplateResource\Pages;
use App\Filament\Resources\PurchaseRequisitionTemplateResource\RelationManagers;
use App\Models\Item;
...
class PurchaseRequisitionTemplateResource extends Resource
{
    protected static ?string $model = PurchaseRequisitionTemplate::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Purchase Requisition Template Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
                            ...
                            Repeater::make('purchaseRequisitionTemplateMultiple')
                                ->relationship('purchaseRequisitionTemplateMultiple')
                                ->schema([
                                    Select::make('item_id')
                                        ->label('Item')
    ...
    {
        return [
            'index' => Pages\ListPurchaseRequisitionTemplates::route('/'),
            'create' => Pages\CreatePurchaseRequisitionTemplate::route('/create'),
            'edit' => Pages\EditPurchaseRequisitionTemplate::route('/{record}/edit'),
        ];
    }
