...
use App\Filament\Resources\IncomingCashPaymentResource\Pages;
use App\Filament\Resources\IncomingCashPaymentResource\RelationManagers;
use App\Models\IncomingCashPayment;
use Filament\Forms;
...
class IncomingCashPaymentResource extends Resource
{
    protected static ?string $model = IncomingCashPayment::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Incoming Cash Payment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('incomingCashPaymentMultiple')
                                            ->relationship('incomingCashPaymentMultiple')
                                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListIncomingCashPayments::route('/'),
            'create' => Pages\CreateIncomingCashPayment::route('/create'),
            'edit' => Pages\EditIncomingCashPayment::route('/{record}/edit'),
        ];
    }
