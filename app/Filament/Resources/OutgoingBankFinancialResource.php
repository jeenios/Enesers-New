...
use App\Filament\Resources\OutgoingBankFinancialResource\Pages;
use App\Filament\Resources\OutgoingBankFinancialResource\RelationManagers;
use App\Models\OutgoingBankFinancial;
use Filament\Forms;
...
class OutgoingBankFinancialResource extends Resource
{
    protected static ?string $model = OutgoingBankFinancial::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Tabs::make('Outgoing Bank Payment Information')
                    ->tabs([
                            ...
                            ->schema([
                                Grid::make(1)
                                    ->schema([
                                        ...
                                        Repeater::make('outgoingBankPaymentMultiple')
                                            ->relationship('outgoingBankPaymentMultiple')
                                            ->schema([
    ...
    {
        return [
            'index' => Pages\ListOutgoingBankFinancials::route('/'),
            'create' => Pages\CreateOutgoingBankFinancial::route('/create'),
            'edit' => Pages\EditOutgoingBankFinancial::route('/{record}/edit'),
        ];
    }
