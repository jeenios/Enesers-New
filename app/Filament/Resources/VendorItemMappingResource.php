...
use App\Filament\Resources\VendorItemMappingResource\Pages;
use App\Filament\Resources\VendorItemMappingResource\RelationManagers;
use App\Models\Item;
...
class VendorItemMappingResource extends Resource
{
    protected static ?string $model = VendorItemMapping::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Vendor Mapping Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
                            ...
                            Repeater::make('vendorItemMappingMultiple')
                                ->relationship('vendorItemMappingMultiple')
                                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('vendorItemMappingMultiple.vendor.name')
                    ->label('Vendor')
                    ->listWithLineBreaks()
                    ->getStateUsing(function ($record) {
                        return $record->vendorItemMappingMultiple
                            ->pluck('vendor.name')
                            ->filter()
                            ->unique()
    ...
    {
        return [
            'index' => Pages\ListVendorItemMappings::route('/'),
            'create' => Pages\CreateVendorItemMapping::route('/create'),
            'edit' => Pages\EditVendorItemMapping::route('/{record}/edit'),
        ];
    }
