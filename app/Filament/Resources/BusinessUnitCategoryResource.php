...
use App\Filament\Resources\BusinessUnitCategoryResource\Pages;
use App\Filament\Resources\BusinessUnitCategoryResource\RelationManagers;
...
class BusinessUnitCategoryResource extends Resource
{
    protected static ?string $model = BusinessUnitCategory::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Business Unit Categories Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
    ...
    {
        return [
            'index' => Pages\ListBusinessUnitCategories::route('/'),
            'create' => Pages\CreateBusinessUnitCategory::route('/create'),
            'edit' => Pages\EditBusinessUnitCategory::route('/{record}/edit'),
        ];
    }
