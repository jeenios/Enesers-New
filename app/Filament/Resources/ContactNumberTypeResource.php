...
use App\Filament\Resources\ContactNumberTypeResource\Pages;
use App\Filament\Resources\ContactNumberTypeResource\RelationManagers;
use App\Models\ContactNumberType;
use Filament\Forms;
...
class ContactNumberTypeResource extends Resource
{
    protected static ?string $model = ContactNumberType::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Contact Number Type Information')
                    ->schema([
                        Grid::make(1)->schema([
                            TextInput::make('code')
                                ->label('Code')
    ...
    {
        return [
            'index' => Pages\ListContactNumberTypes::route('/'),
            'create' => Pages\CreateContactNumberType::route('/create'),
            'edit' => Pages\EditContactNumberType::route('/{record}/edit'),
        ];
    }
